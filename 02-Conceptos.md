...
Table: (\#tab:tab-BigCity)Total de personas, ingresos y gastos
...
Table: (\#tab:tab-sizes)Tamaños de muestra y factores de expansión por estrato
...
Table: (\#tab:tab-frameII)Muestra de UPMs con información del marco de muestreo (primeras 8 filas)
...
Table: (\#tab:tab-encuesta)Primeras observaciones de la muestra final seleccionada
...
Table: (\#tab:tab-cal-totales)Población representada por zona y sexo tras la calibración
...
![(\#fig:fig-hist-pesos)Distribución de los pesos de muestreo originales y calibrados](02-Conceptos_files/figure-docx/fig-hist-pesos-1.png){width=100%}
...
![(\#fig:fig-disp-pesos)Relación entre los pesos de muestreo originales y calibrados](02-Conceptos_files/figure-docx/fig-disp-pesos-1.png){width=70%}
