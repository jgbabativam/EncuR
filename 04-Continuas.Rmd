...
```{r tab-total-ingreso, tab.cap="Estimación del total de ingresos de los hogares con intervalo de confianza al 95%"}
diseno %>% 
...
```{r tab-razon-gasto-ingreso, tab.cap="Razón gasto/ingreso de los hogares"}
diseno %>% 
...
```{r tab-gini, tab.cap="Estimación del coeficiente de Gini para el ingreso de los hogares"}
library(convey)
